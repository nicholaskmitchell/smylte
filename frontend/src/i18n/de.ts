...
export const de: Catalogue = {
  ...
  'settings.icon.auto': 'Windows-Design folgen',
  'settings.icon.paper': 'Cremefarbene Platte',
  'settings.icon.ink': 'Tiefschwarze Platte',
  ...
  'disp.neverSeen': 'Nie verbunden',
  'disp.setUp': 'Einrichten',
  'disp.done': 'Fertig',
  'disp.name': 'Name',
  'disp.namePlaceholder': 'Flur',
  'disp.refresh': 'Aktualisiert',
  'disp.refresh.60': 'Jede Minute',
  'disp.refresh.180': 'Alle 3 Minuten',
  'disp.refresh.300': 'Alle 5 Minuten',
  ...
  'settings.focus.longBreak': 'Lange Pause',
  'settings.focus.longEvery': 'Lange Pause nach je',
  ...
  'settings.focus.on': 'An',
  'settings.focus.off': 'Aus',
  'settings.focus.notifyAllow': 'Benachrichtigungen erlauben',
  ...
  'today.moreActions': 'Weitere Aktionen',
  ...
  'today.est': 'schätz',
  'today.startWorking': 'Loslegen',
  'today.worked': '{amount} gearbeitet',

  // ── die Fokus-Oberfläche (/focus) ──
  'focus.title': 'Fokus',
  'focus.interval': 'Intervall {n}',
  'focus.tally': '{done} / {total} erledigt',
  'focus.back': 'Zurück zu Heute',
  'focus.phase.focus': 'Fokus',
  'focus.phase.break': 'Pause',
  'focus.phase.longBreak': 'Lange Pause',
  'focus.phase.over': 'Intervall vorbei',
  ...
  'focus.next': 'Danach',
  'focus.behind': { one: '+1 dahinter', other: '+{count} dahinter' },
  'focus.est': '{amount} geschätzt',
  'focus.worked': '{amount} gearbeitet',
  'focus.cap.capped': 'Stoppt bei der Schätzung',
  'focus.cap.open': 'Bis es fertig ist',
  'focus.cap.aria': 'Ob bei der Schätzung Schluss ist',
  'focus.done': 'Erledigt',
  'focus.notNow': 'Nicht jetzt',
  'focus.pause': 'Anhalten',
  'focus.resume': 'Weiter',
  'focus.takeBreak': 'Pause machen',
  'focus.keepGoing': 'Weitermachen',
  'focus.skipBreak': 'Pause überspringen',
  'focus.nextInterval': 'Nächstes Intervall starten',
  'focus.end': 'Sitzung beenden',
  'focus.start': 'Loslegen',
  'focus.startAgain': 'Noch einmal loslegen',
