...
A `[x]` entry has been fixed. It stays here rather than being deleted: the GitHub
cluster issue links to its evidence, which is also what the regression test asserts.
